...
Sample usage:
python preprocessors/cc12m_disk_2.py <CC12M tsv file> <CC12M images folder> <output file name (without extension)>
python preprocessors/cc12m_disk_2.py datasets/cc12m/cc12m_translate_final.tsv disk2/datasets/cc12m/images datasets/cc12m/cc12m_dataset_disk2

The script will output two files: cc12m_dataset_disk2_train.json and cc12m_dataset_disk2_val.json
"""
...
if len(sys.argv) != 4:
    print("Provide .tsv file name, images dir, output file name. e.g. python preprocessors/cc12m_disk_2.py datasets/cc12m/cc12m_translate_final.tsv disk2/datasets/cc12m/images datasets/cc12m/cc12m_dataset_disk2")
    exit(1)
